Redmine::Plugin.register :cosmosys do
  ...
  menu :project_menu, :cosmosys_show, {:controller => 'cosmosys', :action => 'show' }, :caption => 'MainReport', :after => :overview, :param => :id
  menu :project_menu, :cosmosys_treeview, {:controller => 'cosmosys', :action => 'treeview' }, :caption => 'Directory', :after => :overview, :param => :id
